  ...
  return (
    <>
      <SEOHead
        ...
        keywords={[
          'About eYogi Gurukul', 'Hindu Education Mission', 'Vedic Learning Philosophy',
          'Sanatan Dharma Education', 'Hindu Culture Preservation', 'Vedic Wisdom Sharing',
          'Traditional Hindu Education', 'Authentic Hindu Teaching', 'Hindu Heritage Mission',
          'Vedic Knowledge Preservation', 'Hindu Spiritual Education', 'Dharma Education Mission',
          'Hindu Values Teaching', 'Indian Hindu Culture Education', 'Vedic Tradition Learning'
        ]}
        canonicalUrl="/about"
        structuredData={[
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                ...
                solutions to modern challenges through time-tested principles of dharma, meditation, 
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Connecting timeless wisdom with contemporary life</p>
                </div>
              </div>
            </div>
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">
              Growing community of learners worldwide
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We envision a world where ancient wisdom and modern knowledge work together to create 
              a more peaceful, harmonious, and spiritually aware global community. Through education, 
              we aim to bridge cultural divides and foster understanding between different traditions 
              and ways of life.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Making Vedic wisdom accessible to learners worldwide</p>
              </div>
              <div className="text-center">
                <div className="h-12 w-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">Maintaining the highest standards in spiritual education</p>
              </div>
              <div className="text-center">
                <div className="h-12 w-12 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600 text-sm">Teaching with love, respect, and understanding</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding gradient-bg text-white">
        <div className="container-max text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Become part of a global community dedicated to learning, growing, and sharing 
            the timeless wisdom of Vedic traditions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/auth/signup">
