  ...
  return (
    <>
      <SEOHead
        ...
        description={gurukul ? `${gurukul.description} Learn authentic Hindu traditions and Vedic wisdom through expert-led courses in our specialized ${gurukul.name}.` : 'Explore our Hindu Gurukul for traditional Vedic education.'}
        keywords={gurukul ? [
          `${gurukul.name} Online`, `${gurukul.name.replace(' Gurukul', '')} Education`,
          `Hindu ${gurukul.name.replace(' Gurukul', '')} Learning`, `Vedic ${gurukul.name.replace(' Gurukul', '')} Courses`,
          `Sanatan Dharma ${gurukul.name.replace(' Gurukul', '')}`, `Traditional ${gurukul.name.replace(' Gurukul', '')} Education`,
          `Authentic Hindu ${gurukul.name.replace(' Gurukul', '')}`, `${gurukul.name.replace(' Gurukul', '')} Online Classes`,
          'Hindu Gurukul Online', 'Vedic Learning Center', 'Traditional Hindu Education'
        ] : []}
        canonicalUrl={gurukul ? `/gurukuls/${gurukul.slug}` : '/gurukuls'}
        structuredData={gurukul ? [
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src={gurukul.image_url || `https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=600&h=600&fit=crop`}
                  alt={gurukul.name}
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">{levelCounts.elementary || 0}</div>
              <div className="text-gray-600">Elementary</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">{levelCounts.basic || 0}</div>
              <div className="text-gray-600">Basic</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">{levelCounts.intermediate + levelCounts.advanced || 0}</div>
      ...
      <section className="section-padding gradient-bg text-white">
        <div className="container-max text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of students worldwide in discovering the wisdom of {gurukul.name.toLowerCase()}.
          </p>
