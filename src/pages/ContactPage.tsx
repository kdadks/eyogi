  ...
  return (
    <>
      <SEOHead
        ...
        keywords={[
          'Contact Hindu Education', 'eYogi Gurukul Contact', 'Hindu Course Support',
          'Vedic Learning Help', 'Sanatan Dharma Questions', 'Hindu Education Support',
          'Gurukul Contact Information', 'Hindu Course Enrollment Help', 'Vedic Education Inquiry',
          'Hindu Learning Support', 'Traditional Hindu Education Contact', 'Hindu Culture Questions'
        ]}
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Our AI chatbot is available 24/7 to answer common questions and provide instant support.
                </p>
      ...
      <section className="section-padding gradient-bg text-white">
        <div className="container-max text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Don't wait! Join thousands of students worldwide in discovering the timeless 
            wisdom of Vedic traditions.
          </p>
