  ...
  return (
    <>
      <SEOHead
        ...
        keywords={[
          'Hindu Gurukul Online', 'Vedic Learning Centers', 'Traditional Hindu Education',
          'Sanatan Dharma Gurukuls', 'Hindu Philosophy Gurukul', 'Sanskrit Gurukul Online',
          'Mantra Gurukul', 'Yoga Gurukul', 'Hindu Culture Gurukul', 'Vedic Education Centers',
          'Authentic Hindu Gurukul', 'Indian Gurukul System', 'Hindu Heritage Centers',
          'Vedic Wisdom Gurukuls', 'Hindu Spiritual Centers', 'Traditional Hindu Schools'
        ]}
        ...
        <div className="container-max section-padding">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Each Gurukul specializes in different aspects of Vedic knowledge, offering comprehensive 
              learning paths designed for students of all ages. Discover ancient wisdom through modern, 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Each Gurukul offers focused, in-depth study of specific aspects of Vedic knowledge.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Learn from qualified instructors with deep knowledge and authentic understanding.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Earn certificates upon completion and showcase your achievements in Vedic studies.
              </p>
            </div>
          </div>
        </div>
