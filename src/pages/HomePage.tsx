            ...
            <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
              <div className="space-y-4 px-4 sm:px-0">
                <div className="flex justify-center lg:justify-start badge-container">
                  <Badge variant="info" className="text-xs sm:text-sm px-3 py-2 sm:px-4 sm:py-2 hero-badge">
                    🕉️ Authentic Hindu Education & Vedic Learning
                  </Badge>
                </div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight px-2 sm:px-0" itemProp="headline">
                  Learn Authentic <span className="gradient-text">Hindu Heritage</span> & Vedic Wisdom
                </h1>
                <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed px-2 sm:px-0" itemProp="description">
              ...
              <div className="absolute -bottom-4 left-2 sm:left-0 sm:-left-4 lg:-bottom-6 lg:-left-6 bg-white/90 backdrop-blur-md rounded-lg shadow-xl p-3 lg:p-4 border border-white/30 relative hero-certificate-card">
                ...
                <div className="relative z-10 flex items-center space-x-2 lg:space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-semibold text-gray-900 text-sm lg:text-base">Certified Hindu Education</p>
        ...
        <div className="container-max text-center">
          ...
          <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row justify-center max-w-sm sm:max-w-none mx-auto px-4">
            <ScrollLink to="/auth/signup" className="w-full sm:w-auto">
              <Button variant="secondary" size="lg" className="bg-white text-orange-600 hover:bg-gray-100 w-full sm:w-auto min-h-[50px] font-semibold text-base px-6 py-3">
                Start Hindu Learning Free
              </Button>
            </ScrollLink>
            <ScrollLink to="/courses" className="w-full sm:w-auto">
              <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-orange-600 w-full sm:w-auto min-h-[50px] font-semibold text-base px-6 py-3">
