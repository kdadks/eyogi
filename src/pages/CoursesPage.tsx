...
export default function CoursesPage() {
  ...
  const loadData = async () => {
    try {
      const [coursesData, gurukulData] = await Promise.all([
        getCourses(),
        getGurukuls()
      ])
  ...
  const filteredCourses = courses.filter(course => {
    ...
    const matchesAge = !ageGroup || (
      course.age_group_min <= parseInt(ageGroup) && 
      course.age_group_max >= parseInt(ageGroup)
    )
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={[
          'Hindu Courses Online', 'Vedic Education Programs', 'Sanatan Dharma Classes',
          'Hindu Philosophy Courses', 'Sanskrit Courses Online', 'Hindu Culture Classes',
          'Vedic Studies Courses', 'Hindu Religion Education', 'Traditional Hindu Learning',
          'Hindu Spiritual Courses', 'Dharma Education Classes', 'Hindu Heritage Courses',
          'Vedic Wisdom Programs', 'Hindu Online Classes', 'Indian Hindu Education',
          'Hindu Gurukul Courses', 'Authentic Hindu Teaching', 'Hindu Values Education'
        ]}
